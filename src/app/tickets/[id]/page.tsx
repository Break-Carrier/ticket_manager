...
import { TICKET_STATUSES, TicketStatus, getStatusColor } from '@/utils/ticketStatus';
  ...
  if (error) {
    return (
      <div className="container mx-auto px-4 py-8">
        ...
        <Link href="/tickets" className="bg-gray-500 hover:bg-gray-600 text-white font-bold py-2 px-4 rounded-lg transition duration-300 ease-in-out">
          Retour à la liste
        </Link>
      </div>
    );
